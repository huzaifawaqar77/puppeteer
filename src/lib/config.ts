export const appwriteConfig = {
  endpoint: process.env.NEXT_PUBLIC_APPWRITE_ENDPOINT || "https://appwrite.uiflexer.com/v1",
  projectId: process.env.NEXT_PUBLIC_APPWRITE_PROJECT_ID || "68c77b650020a2e5fa47",
...
export const stirlingConfig = {
  ...
  apiKey: process.env.STIRLING_PDF_API_KEY || "75e0b668-27be-423c-8016-5b1ccd1c19d9",
};
