    ...
    <div className="container mx-auto max-w-4xl py-8 px-4">
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 text-gray-400">Rotate pages in your PDF document.</p>
        </div>
        ...
        {file && (
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Rotation Angle</label>
                ...
                {[90, 180, 270].map((deg) => (
                  ...
                  >
                    <div className="flex flex-col items-center gap-2">
                      <RotateCw className={`h-5 w-5 ${angle === deg ? "animate-spin-slow" : ""}`} />
                      <span>{deg}°</span>
                    </div>
                  </button>
                ))}
