...
import { Loader2, Download, ScanText } from "lucide-react";
  ...
  return (
    <div className="container mx-auto max-w-4xl py-8 px-4">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-white">OCR PDF</h1>
          <p className="mt-2 text-gray-400">Make scanned PDFs searchable and selectable using OCR.</p>
        </div>
